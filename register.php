...
if(isset($_POST["register"]))
{
	...
	else
	{
		...
		if(isset($result))
		{
			$base_url = "http://localhost/email-address-verification-script-using-php/";  //change this baseurl value as per your file path
			$mail_body = "
			...
			$mail->Username = 'swarginterior@gmail.com';					//Sets SMTP username
			$mail->Password = 'Jitu1618@123';					//Sets SMTP password
			$mail->SMTPSecure = '';							//Sets connection prefix. Options are "", "ssl" or "tls"
			$mail->From = 'swarginterior@gmail.com';			//Sets the From email address for the message
			$mail->FromName = 'Swarg Interior';					//Sets the From name of the message
